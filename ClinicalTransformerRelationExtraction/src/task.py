...
class TaskRunner(object):
    ...
    def _init_new_model(self):
        ...
        self.tokenizer = tokenizer.from_pretrained(self.args.pretrained_model, do_lower_case=self.args.do_lower_case, is_fast=True)
    ...
    def _init_trained_model(self):
        ...
        self.tokenizer = tokenizer.from_pretrained(latest_ckpt_dir, do_lower_case=self.args.do_lower_case, is_fast=True)
